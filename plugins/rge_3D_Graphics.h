#ifndef jpr_RGEX_GFX3D
#define jpr_RGEX_GFX3D
...
public:
    ...
    public:
        ...
        inline static mat4x4 Mat_Inverse(jpr::GFX3D::mat4x4 &m);
    ...
    public:
        ...
        void SetCamera(jpr::GFX3D::vec3d &pos, jpr::GFX3D::vec3d &lookat, jpr::GFX3D::vec3d &up);
        void SetTransform(jpr::GFX3D::mat4x4 &transform);
        void SetTexture(jpr::Sprite *texture);
        void SetLightSource(jpr::GFX3D::vec3d &pos, jpr::GFX3D::vec3d &dir, jpr::Retro &col);
        uint32_t Render(std::vector<jpr::GFX3D::triangle> &triangles, uint32_t flags = RENDER_CULL_CW | RENDER_TEXTURED | RENDER_DEPTH);

    private:
        jpr::GFX3D::mat4x4 matProj;
        jpr::GFX3D::mat4x4 matView;
        jpr::GFX3D::mat4x4 matWorld;
        jpr::Sprite *sprTexture;
        float fViewX;
        float fViewY;
        float fViewW;
        float fViewH;
...
public:
    ...
    inline static void AddTriangleToScene(jpr::GFX3D::triangle &tri);
    inline static void RenderScene();

    inline static void DrawTriangleFlat(jpr::GFX3D::triangle &tri);
    inline static void DrawTriangleWire(jpr::GFX3D::triangle &tri, jpr::Retro col = jpr::WHITE);
    inline static void DrawTriangleTex(jpr::GFX3D::triangle &tri, jpr::Sprite *spr);
    inline static void TexturedTriangle(int x1, int y1, float u1, float v1, float w1,
                                        int x2, int y2, float u2, float v2, float w2,
                                        int x3, int y3, float u3, float v3, float w3, jpr::Sprite *spr);

    // Draws a sprite with the transform applied
    //inline static void DrawSprite(jpr::Sprite *sprite, jpr::GFX2D::Transform2D &transform);
...
jpr::GFX3D::vec3d jpr::GFX3D::Math::Mat_MultiplyVector(jpr::GFX3D::mat4x4 &m, jpr::GFX3D::vec3d &i)
{
    vec3d v;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeIdentity()
{
    jpr::GFX3D::mat4x4 matrix;
    matrix.m[0][0] = 1.0f;
    matrix.m[1][1] = 1.0f;
    matrix.m[2][2] = 1.0f;
    matrix.m[3][3] = 1.0f;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeRotationX(float fAngleRad)
{
    jpr::GFX3D::mat4x4 matrix;
    matrix.m[0][0] = 1.0f;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeRotationY(float fAngleRad)
{
    jpr::GFX3D::mat4x4 matrix;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeRotationZ(float fAngleRad)
{
    jpr::GFX3D::mat4x4 matrix;
    matrix.m[0][0] = cosf(fAngleRad);
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeScale(float x, float y, float z)
{
    jpr::GFX3D::mat4x4 matrix;
    matrix.m[0][0] = x;
    matrix.m[1][1] = y;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeTranslation(float x, float y, float z)
{
    jpr::GFX3D::mat4x4 matrix;
    matrix.m[0][0] = 1.0f;
    matrix.m[1][1] = 1.0f;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MakeProjection(float fFovDegrees, float fAspectRatio, float fNear, float fFar)
{
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_MultiplyMatrix(jpr::GFX3D::mat4x4 &m1, jpr::GFX3D::mat4x4 &m2)
{
    jpr::GFX3D::mat4x4 matrix;
    for (int c = 0; c < 4; c++)
        for (int r = 0; r < 4; r++)
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_PointAt(jpr::GFX3D::vec3d &pos, jpr::GFX3D::vec3d &target, jpr::GFX3D::vec3d &up)
{
    // Calculate new forward direction
    jpr::GFX3D::vec3d newForward = Vec_Sub(target, pos);
    newForward = Vec_Normalise(newForward);

    // Calculate new Up direction
    jpr::GFX3D::vec3d a = Vec_Mul(newForward, Vec_DotProduct(up, newForward));
    jpr::GFX3D::vec3d newUp = Vec_Sub(up, a);
    newUp = Vec_Normalise(newUp);

    // New Right direction is easy, its just cross product
    jpr::GFX3D::vec3d newRight = Vec_CrossProduct(newUp, newForward);
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_QuickInverse(jpr::GFX3D::mat4x4 &m) // Only for Rotation/Translation Matrices
{
    jpr::GFX3D::mat4x4 matrix;
...
jpr::GFX3D::mat4x4 jpr::GFX3D::Math::Mat_Inverse(jpr::GFX3D::mat4x4 &m)
{
    double det;
...
jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_Add(jpr::GFX3D::vec3d &v1, jpr::GFX3D::vec3d &v2)
{
    return {v1.x + v2.x, v1.y + v2.y, v1.z + v2.z};
}

jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_Sub(jpr::GFX3D::vec3d &v1, jpr::GFX3D::vec3d &v2)
{
    return {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z};
}

jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_Mul(jpr::GFX3D::vec3d &v1, float k)
{
    return {v1.x * k, v1.y * k, v1.z * k};
}

jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_Div(jpr::GFX3D::vec3d &v1, float k)
{
    return {v1.x / k, v1.y / k, v1.z / k};
}

float jpr::GFX3D::Math::Vec_DotProduct(jpr::GFX3D::vec3d &v1, jpr::GFX3D::vec3d &v2)
{
    return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
}

float jpr::GFX3D::Math::Vec_Length(jpr::GFX3D::vec3d &v)
{
    return sqrtf(Vec_DotProduct(v, v));
}

jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_Normalise(jpr::GFX3D::vec3d &v)
{
    float l = Vec_Length(v);
    return {v.x / l, v.y / l, v.z / l};
}

jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_CrossProduct(jpr::GFX3D::vec3d &v1, jpr::GFX3D::vec3d &v2)
{
    vec3d v;
...
jpr::GFX3D::vec3d jpr::GFX3D::Math::Vec_IntersectPlane(jpr::GFX3D::vec3d &plane_p, jpr::GFX3D::vec3d &plane_n, jpr::GFX3D::vec3d &lineStart, jpr::GFX3D::vec3d &lineEnd, float &t)
{
    ...
    t = (-plane_d - ad) / (bd - ad);
    jpr::GFX3D::vec3d lineStartToEnd = Vec_Sub(lineEnd, lineStart);
    jpr::GFX3D::vec3d lineToIntersect = Vec_Mul(lineStartToEnd, t);
    return Vec_Add(lineStart, lineToIntersect);
}

int jpr::GFX3D::Math::Triangle_ClipAgainstPlane(vec3d plane_p, vec3d plane_n, triangle &in_tri, triangle &out_tri1, triangle &out_tri2)
{
    ...
    if (nInsidePointCount == 1 && nOutsidePointCount == 2)
    {
        ...
        out_tri1.col = jpr::MAGENTA; // in_tri.col;
    ...
    if (nInsidePointCount == 2 && nOutsidePointCount == 1)
    {
        ...
        out_tri1.col = jpr::GREEN; // in_tri.col;
        out_tri2.col = jpr::RED;   // in_tri.col;
...
void GFX3D::DrawTriangleFlat(jpr::GFX3D::triangle &tri)
{
    pge->FillTriangle(tri.p[0].x, tri.p[0].y, tri.p[1].x, tri.p[1].y, tri.p[2].x, tri.p[2].y, tri.col);
}

void GFX3D::DrawTriangleWire(jpr::GFX3D::triangle &tri, jpr::Retro col)
{
...
void GFX3D::DrawTriangleTex(jpr::GFX3D::triangle &tri, jpr::Sprite *spr)
{
...
void GFX3D::PipeLine::SetCamera(jpr::GFX3D::vec3d &pos, jpr::GFX3D::vec3d &lookat, jpr::GFX3D::vec3d &up)
{
    matView = GFX3D::Math::Mat_PointAt(pos, lookat, up);
    matView = GFX3D::Math::Mat_QuickInverse(matView);
}

void GFX3D::PipeLine::SetTransform(jpr::GFX3D::mat4x4 &transform)
{
    matWorld = transform;
}

void GFX3D::PipeLine::SetTexture(jpr::Sprite *texture)
{
    sprTexture = texture;
}

void GFX3D::PipeLine::SetLightSource(jpr::GFX3D::vec3d &pos, jpr::GFX3D::vec3d &dir, jpr::Retro &col)
{
}

uint32_t GFX3D::PipeLine::Render(std::vector<jpr::GFX3D::triangle> &triangles, uint32_t flags)
{
    ...
    for (auto &tri : triangles)
    {
        ...
        for (int n = 0; n < nClippedTriangles; n++)
        {
            ...
            for (auto &triRaster : listTriangles)
            {
                ...
                {
                    DrawTriangleWire(triRaster, jpr::RED);
                }
