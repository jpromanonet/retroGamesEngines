...
namespace jpr // All jpromanonet stuff will now exist in the "jpr" namespace
{
	struct Pixel
	{
		union {
...
namespace jpr
{
	...
	LRESULT CALLBACK RetroGameEngine::jpr_WindowEvent(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		{
		case WM_CREATE:
			sge = (RetroGameEngine *)((LPCREATESTRUCT)lParam)->lpCreateParams;
			return 0;
		case WM_MOUSEMOVE:
		{
